...
export const PROFILE_MESSAGES: Record<ProfileType['id'], string> = {
  ...
  reactivador: 'Tu ingles escrito es A2-B1. Tienes mucho ingles dormido — no necesitas aprenderlo de nuevo, necesitas activarlo. En 2 semanas notaras la diferencia.',
